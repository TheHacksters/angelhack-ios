...
@implementation AHMyEventTableViewCell
...
- (IBAction)disclosureButtonAction:(id)sender {
    if ([self.delegate respondsToSelector:@selector(eventTableCellDisclosureButtonTouchedAtIndexPath:)]) {
        [self.delegate eventTableCellDisclosureButtonTouchedAtIndexPath:self.indexPath];
    }
}
