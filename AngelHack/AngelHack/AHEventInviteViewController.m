...
@interface AHEventInviteViewController () <UITableViewDelegate, UITableViewDataSource, TableCellDelegate>
...
@implementation AHEventInviteViewController
